...
//        PDF for Attendance
    ...
    public void onBackPressed() {
        Intent i = new Intent(Attendance1.this, FirstNav.class);
...
*/
            ...
            Intent i = new Intent(Attendance1.this, Attendance1.class);
            i.putExtra("USERNAME", Name_DB);// Transfer name from this class to Profile
            i.putExtra("USERID", ID_DB);
            i.addFlags( Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(i);
            ...
            Intent i = new Intent(Attendance1.this, SettingsActivity.class);
            i.putExtra("USERNAME", Name_DB);// Transfer name from this class to Profile
            i.putExtra("USERID", ID_DB);
            i.addFlags( Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(i);
            ...
            Toast.makeText(Attendance1.this, " Link to webite ", Toast.LENGTH_SHORT).show();
